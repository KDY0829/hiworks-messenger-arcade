...
export function QuizSettings({busy,host,help,onStart}:{busy:boolean;host:boolean;help:boolean;onStart:(settings:QuizSettings)=>Promise<boolean>}){
 ...
 return <>
  ...
  {help&&<div className="rules">혼자 또는 함께 주관식 문제를 풉니다.<br/>문제가 화면에 표시된 뒤 5초에 초성·글자 수, 10초에 추가 힌트, 15초에 정답이 공개됩니다.<br/>힌트 전 3점 · 첫 힌트 뒤 2점 · 추가 힌트 뒤 1점<br/>틀리면 1.5초 뒤 다시 답할 수 있으며 문제당 최대 4회입니다.<br/>외부 문제는 서버 캐시에 저장되어 장애 중에도 기존 문제로 진행됩니다.</div>}
 </>;
}
